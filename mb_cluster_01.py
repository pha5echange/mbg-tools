...
# Writes run log to 'logs/mb_cluster_versionNumber_log.txt'
...
logPath = os.path.join("logs", 'mb_cluster_' + versionNumber + '_log.txt')
...
# ..and begin..
runLog.write ('\n' + 'MusicBrainz Data Cluster Finder | ' + 'Version: ' + versionNumber + '\n' + '\n')
print ('\n' + 'MusicBrainz Data Cluster Finder | ' + 'Version: ' + versionNumber + ' | Starting' + '\n')
