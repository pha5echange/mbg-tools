...
logPath = os.path.join("logs", 'mb_nhm_line_plotter_' + versionNumber + '_log.txt')
runLog = open(logPath, 'a')

# define paths for graphs
#graphHPath = os.path.join("graphs", 'nhm_plotter_' + versionNumber + ".eps")
nodeHPath = os.path.join("graphs", 'mb_nhm_h_line_plot_' + versionNumber + ".eps")
graphPercPath = os.path.join("graphs", 'mb_nhm_p_line_plot_' + versionNumber + ".eps")
...
# ..and begin..
runLog.write ('\n' + 'MB Network Hybridity Metric Line Plotter - Beta | ' + 'Version: ' + versionNumber + '\n' + '\n')
print ('\n' + 'MB Network Hybridity Metric Line Plotter - Beta | ' + 'Version: ' + versionNumber + ' | Starting' + '\n' +'\n')
