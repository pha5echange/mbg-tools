...
# Processes file 'data/mb_nhm_plot.txt' and produces 2 charts: 
...
# edit `data/mb_nhm_plot.txt' to define datapoints (by removing unwanted years/lines).
...
logPath = os.path.join("logs", 'mb_nhm_bar_plotter_' + versionNumber + '_log.txt')
runLog = open(logPath, 'a')

# define paths for graphs
#graphHPath = os.path.join("graphs", 'mb_nhm_plotter_' + versionNumber + ".eps")
nodeHPath = os.path.join("graphs", 'mb_nhm_h_bar_plot_' + versionNumber + ".eps")
graphPercPath = os.path.join("graphs", 'mb_nhm_p_bar_plot_' + versionNumber + ".eps")
...
# ..and begin..
runLog.write ('\n' + 'MB Network Hybridity Metric Bar Plotter - Beta | ' + 'Version: ' + versionNumber + '\n' + '\n')
print ('\n' + 'MB Network Hybridity Metric Bar Plotter - Beta | ' + 'Version: ' + versionNumber + ' | Starting' + '\n' +'\n')

# look for file in 'data' subfolder
pathname = os.path.join("data", 'mb_nhm_plot.txt')
